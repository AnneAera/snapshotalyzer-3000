...
## add nother option to list all snapshot, inetad of the latest one Only
...
## following added for list the most recent completed one
...
@cli.group('instances')
##group of commands for instances
def instances():
...
def create_snapshots(project):
    ...
    for i in instances:
        ...
        for v in i.volumes.all():
            ...
            v.create_snapshot(Description="Create by SnapshotAlyzer 3000")
